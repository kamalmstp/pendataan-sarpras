            ...
            <div class="row justify-content-center push">
                <div class="col-md-10">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Masukkan Judul" required="required">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-6">
                            ...
                            <div class="mt-2">
                                <img class="img-fluid" id="image_prev" src="" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Isi Post</label>
                        <textarea id="js-ckeditor" name="blog"></textarea>
                    </div>
                    <div class="mb-4">
