...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jun 2022 pada 11.06
...
--
-- Struktur dari tabel `jumlah_siswa`
--
...
--
-- Dumping data untuk tabel `jumlah_siswa`
--
...
INSERT INTO `peralatan` (`id`, `nama_peralatan`, `jumlah`, `tahun_peroleh`, `sumber_dana`, `kondisi_alat`, `id_sekolah`) VALUES
(1, 'komputer', 12, 2022, 'paylater', 'Baik', NULL),
(2, 'komputer', 12, 2022, 'paylater', 'Baik', NULL),
(3, 'kipas', 7, 2020, 'cod', 'Baik', NULL),
(4, 'ac', 28, 2019, 'shopee cod', 'Baik', 1),
(5, 'motor', 7, 2019, 'astra finance', 'Baik', 1);
...
(4, '2022-06-07 09:28:58', '2022-06-08 06:03:43', 'Kelas 1', '5', '10', 'Baik', NULL, '2002', '18', '2', '30', '10', 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `ruang_penunjangs`
--
...
--
-- Dumping data untuk tabel `ruang_penunjangs`
--
...
--
-- Dumping data untuk tabel `sanitasi`
--
...
--
-- Indeks untuk tabel `jumlah_siswa`
--
...
--
-- Indeks untuk tabel `ruang_penunjangs`
--
...
--
-- AUTO_INCREMENT untuk tabel `jumlah_siswa`
--
ALTER TABLE `jumlah_siswa`
...
--
-- AUTO_INCREMENT untuk tabel `ruang_penunjangs`
--
ALTER TABLE `ruang_penunjangs`
